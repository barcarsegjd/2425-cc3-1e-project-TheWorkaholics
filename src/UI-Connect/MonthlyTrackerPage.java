...
public class MonthlyTrackerPage {
    ...
    public static void createUI() {
        ...
        switchAccountButton.addActionListener(e -> {
            frame.dispose();
            SwitchAccountPage.constructUISwitch();
        });
    ...
    private static JPanel createTablePanel(String label) {
    ...
    private static void updateTotals(JTable table, DefaultTableModel model) {
