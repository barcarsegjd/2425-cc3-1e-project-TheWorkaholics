...
public class SwitchAccountPage {
    public static void constructUISwitch(){
        ...
        deleteButton.addActionListener(e -> {
            PETHomepageWithLoginFunctionality.deleteAccount();
        });
        addAccountButton.addActionListener(e -> {
            PETHomepageWithLoginFunctionality.addAccountScreen();
        });
        logoutButton.addActionListener(e -> {
            frame.dispose();
            PETHomepageWithLoginFunctionality.showLoginScreen();
        });
